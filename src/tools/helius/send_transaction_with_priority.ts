import { NexisAgentKit, PriorityFeeResponse } from "../../index";
import {
  SystemProgram,
  Transaction,
...
/**
 * Sends a transaction with an estimated priority fee using the provided NexisAgentKit.
 *
 * @param agent         An instance of NexisAgentKit containing connection, wallet, etc.
