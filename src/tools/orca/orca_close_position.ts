 ...
 *
 * ## Parameters
 * - `agent`: The `NexisAgentKit` instance representing the wallet and connection details.
 ...
 *
 * @param agent - The `NexisAgentKit` instance representing the wallet and connection.
