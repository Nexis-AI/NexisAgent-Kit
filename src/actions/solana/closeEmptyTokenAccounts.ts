...
const closeEmptyTokenAccountsAction: Action = {
  ...
  similes: [
    ...
    "close NPL token accounts",
    "clean wallet",
  ],
  description: `Close empty NPL Token accounts associated with your wallet to reclaim rent. 
 This action will close both regular NPL Token accounts and Token-2022 accounts that have zero balance. `,
  examples: [
    [
      {
        input: {},
  ...
  schema: z.object({}),
  handler: async (agent: NexisAgentKit) => {
    try {
