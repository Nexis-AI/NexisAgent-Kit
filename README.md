...
![NPM Downloads](https://img.shields.io/npm/dm/nexis-agent-kit?style=for-the-badge)
![GitHub forks](https://img.shields.io/github/forks/sendaifun/nexis-agent-kit?style=for-the-badge)
![GitHub License](https://img.shields.io/github/license/sendaifun/nexis-agent-kit?style=for-the-badge)
...
[![Run on Repl.it](https://replit.com/badge/github/sendaifun/nexis-agent-kit)](https://replit.com/@sendaifun/Solana-Agent-Kit)
> Replit template created by [Arpit Singh](https://github.com/The-x-35)

## 🔧 Core Blockchain Features

- **Token Operations**
  - Deploy NPL tokens by Metaplex
  - Transfer assets
  - Balance checks
  - Stake SOL
...
- **NFTs on 3.Land**
  ...
  - List your NFT for sale in any NPL token
...
```typescript
const isDevnet = true; // (Optional) if not present TX takes place in Mainnet
const withPool = true; // (Optional) only present if NFT will be created with a Liquidity Pool for a specific NPL token
...
const createItemOptions: CreateSingleOptions = {
  ...
  splHash: "", //present if listing is on a specific NPL token, if not present sale will be on $SOL, must be present if "withPool" is true
...
### Send an NPL Token Airdrop via ZK Compression
...
<a href="https://github.com/sendaifun/nexis-agent-kit/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=sendaifun/nexis-agent-kit" />
</a>

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=sendaifun/nexis-agent-kit&type=Date)](https://star-history.com/#sendaifun/nexis-agent-kit&Date)
