...
- [Contributing to Solana Agent Kit](#contributing-to-nexis-agent-kit)
...
1. **Search** the [existing issues](https://github.com/sendaifun/nexis-agent-kit/issues) to make sure it hasn't been reported.
...
1. **Search** the [existing issues](https://github.com/sendaifun/nexis-agent-kit/issues) to see if it's already been suggested.
...
Check out the [Good First Issues](https://github.com/sendaifun/nexis-agent-kit/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) to get started!
...
- `feat: add ability to deploy new NPL token`
